namespace BarcodeSplitManage
{
	partial class ReadBarcodeOptionsDialogBox
	{
		...
		private void InitializeComponent()
		{
			...
			this._toReadSymbologyListBox = new BarcodeSplitManage.SymbologyListBox();
			...
			this._availableSymbologyListBox = new BarcodeSplitManage.SymbologyListBox();
			...
			this._toReadSymbologyListBox.ItemDoubleClicked += new System.EventHandler<BarcodeSplitManage.SymbologyListBoxItemDoubleClickedEventArgs>(this._toReadSymbologyListBox_ItemDoubleClicked);
			...
			this._availableSymbologyListBox.ItemDoubleClicked += new System.EventHandler<BarcodeSplitManage.SymbologyListBoxItemDoubleClickedEventArgs>(this._availableSymbologyListBox_ItemDoubleClicked);
			...
			this._cmbResolution.Items.AddRange(new object[] {
			resources.GetString("_cmbResolution.Items"),
			resources.GetString("_cmbResolution.Items1"),
			resources.GetString("_cmbResolution.Items2"),
			resources.GetString("_cmbResolution.Items3"),
			resources.GetString("_cmbResolution.Items4"),
			resources.GetString("_cmbResolution.Items5")});
			resources.ApplyResources(this._cmbResolution, "_cmbResolution");
